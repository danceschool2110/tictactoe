...
import LoadingSkeleton from './loading/LoandingSkeleton';
//https://api.themoviedb.org/3/movie/550?api_key=09f3f44dff24a65421540ac4bf6b04c6
// https://api.themoviedb.org/3/search/movie?api_key=09f3f44dff24a65421540ac4bf6b04c6&query=%27%27
const MovieSearchApp = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            const respone = await axios.get(`https://api.themoviedb.org/3/search/movie?api_key=09f3f44dff24a65421540ac4bf6b04c6&query='${queryDebounce}'`)
            console.log(respone.data.results)
            if(respone.data.results) {
...
const MovieItem = ({item})=>{
    ...
    return(
        <div className="bg-white rounded-2xl shadow-sm flex flex-col">
            <div className="p-3 w-[369px] h-[297px]">
                <img
            ...
            <div className="p-7 flex-1 flex flex-col">
                ...
                <p
                    className="text-[#999999] font-normal text-sm mb-6 !leading-loose"
                >
                    {item.overview}
                </p>
                <div className="flex items-center gap-x-3 mt-auto">
                    ...
                    <span className="text-sm font-semibold text-[#333333] ">{item.vote_average}</span>
                </div>
            </div>
        </div>
    )
